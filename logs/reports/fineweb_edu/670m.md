...
|---|---|---|---|
| **Epiplexity** (structural info) | $S_T$ | **0.6527** | 3.39e+09 bits |
| **Time-bounded entropy** (random info) | $H_T$ | **3.8887** | depends on test-set size |
| **Total information** | $S_T + H_T$ | **4.5413** | — |
...
| Metric | Value |
|---|---|
| Structural fraction $S_T / (S_T+H_T)$ | **14.37%** |
...
| $S_T$ per 1B training tokens | 652,654,161 bits |
...
Structural fraction is moderate (14.37%) — the model extracted non-trivial structure (S_T = 0.6527 bits/token, H_T = 3.8887 bits/token).
